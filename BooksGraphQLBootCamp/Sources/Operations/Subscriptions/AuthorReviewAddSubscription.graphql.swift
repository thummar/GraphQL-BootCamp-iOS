...
public class AuthorReviewAddSubscription: GraphQLSubscription {
  public static let operationName: String = "AuthorReviewAddSubscription"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"subscription AuthorReviewAddSubscription { authorReviewAdded { __typename content id rating } }"#
    ))
  ...
  public struct Data: BooksGraphQLBootCamp.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("authorReviewAdded", AuthorReviewAdded?.self),
    ] }

    public var authorReviewAdded: AuthorReviewAdded? { __data["authorReviewAdded"] }

    /// AuthorReviewAdded
    ///
    /// Parent Type: `AutherReview`
    public struct AuthorReviewAdded: BooksGraphQLBootCamp.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
